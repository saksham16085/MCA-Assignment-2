...
features = pkl.load(open('training_spectograms_features_final','rb'))
labels = pkl.load(open('training_spectograms_labels_final','rb'))
features_val = pkl.load(open('validation_spectograms_features_final','rb'))
labels_val = pkl.load(open('validation_spectograms_labels_final','rb'))
...
pkl.dump(clf,open('clf_spec_lin_arsh','wb'))
