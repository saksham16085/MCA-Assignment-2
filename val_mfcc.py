...
features = pkl.load(open('training_mfcc_features_final','rb'))
labels = pkl.load(open('training_mfcc_labels_final','rb'))
features_val = pkl.load(open('validation_mfcc_features_final','rb'))
labels_val = pkl.load(open('validation_mfcc_labels_final','rb'))
...
pkl.dump(clf,open('clf_mfcc_final','wb'))